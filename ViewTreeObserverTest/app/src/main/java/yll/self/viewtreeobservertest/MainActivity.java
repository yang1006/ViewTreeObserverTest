package yll.self.viewtreeobservertest;
        ...
        ViewTreeObserver.OnGlobalFocusChangeListener         // 用于监听焦点的变化
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        all = findViewById(R.id.full_screen);              //得到整个屏幕对象 ，因为顶层layout的width和height都是 fill_parent
        vto =  all.getViewTreeObserver();   // 通过 getViewTreeObserver 获得 ViewTreeObserver 对象
    ...
    // onGlobalFocusChanged 是接口 ViewTreeObserver.OnGlobalFocusChangeListener 中定义的方法。
    // 焦点发生变化时，会触发这个方法的执行
    @Override
    public void onGlobalFocusChanged(View oldFocus, View newFocus) {
        if (oldFocus != null && newFocus != null) {
            tv_display.setText("Focus \nFROM:\t" + oldFocus.toString() + "\n    TO:\t" + newFocus.toString());
        }
    }
